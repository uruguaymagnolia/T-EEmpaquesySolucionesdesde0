  ...
  return (
    ...
    >
      ...
      <ScrollReveal>
        <motion.div
          whileHover={{
            boxShadow: '0 0 25px hsla(var(--primary), 0.2)',
            y: -5,
          }}
          transition={{ type: 'spring', stiffness: 300 }}
          className="relative h-[60vh] min-h-[500px] bg-background-light/50 backdrop-blur-sm rounded-2xl p-4 md:p-8 border border-border/50 overflow-hidden"
        >
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <div className="relative w-12 h-12 rounded-full bg-background-dark border-2 border-primary p-2 shadow-lg">
                     <Logo />
                  </div>
                </motion.div>
                <AnimatePresence>
                  {infoWindowOpen && (
                    ...
                    >
                      <Card className="border-border bg-background-dark/80 backdrop-blur-md shadow-2xl">
                        <CardHeader>
                          <Logo />
                        </CardHeader>
